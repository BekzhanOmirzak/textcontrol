...
class FieldOptionsVM : ViewModel() {
	...
	val addressLink = mutableStateOf("")
	val urlFontSize = mutableStateOf(10)
	val urlTxtColor = mutableStateOf(HsvColor.DEFAULT)
	val urlUnderLineWidth = mutableStateOf(0)
	val urlUnderLineColor = mutableStateOf(HsvColor.DEFAULT)
	...
	fun applyField() {
		...
		urlTarget.value = ""
		addressLink.value = ""
		urlFontSize.value = 10
		urlTxtColor.value = HsvColor.DEFAULT
		urlUnderLineWidth.value = 0
		urlUnderLineColor.value = HsvColor.DEFAULT
